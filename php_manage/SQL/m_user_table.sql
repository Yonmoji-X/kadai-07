...
--
-- テーブルの構造 `m_user_table`
--

CREATE TABLE IF NOT EXISTS `m_user_table` (
`id` int(12) NOT NULL,
...
--
-- テーブルのデータのダンプ `m_user_table`
--

INSERT INTO `m_user_table` (`id`, `name`, `lid`, `lpw`, `kanri_flg`, `life_flg`) VALUES
...
--
-- Indexes for table `m_user_table`
--
ALTER TABLE `m_user_table`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `m_user_table`
--
ALTER TABLE `m_user_table`
