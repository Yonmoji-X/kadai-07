...
CREATE TABLE IF NOT EXISTS `m_an_table` (
    `id` int(12) NOT NULL,
...
--
-- テーブルのデータのダンプ `m_an_table`
--

INSERT INTO `m_an_table` (`id`, `name`, `email`, `naiyou`, `indate`, `age`) VALUES
...
--
-- Indexes for table `m_an_table`
--
ALTER TABLE `m_an_table`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `m_an_table`
--
ALTER TABLE `m_an_table`
